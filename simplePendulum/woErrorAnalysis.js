...
function approximatorRKF45(g, l, dt, t, theta, thetaDot, i) {
    ...
    return [theta1, thetaDoDeltat, theta2, thetaDot2];
}
 ...
 */
function stepSizeChecker(theta1, theta2, thetaDoDeltat, thetaDot2, epsilon, i, dt, t, theta, thetaDot) {
...
function RKF45(dtInitial, epsilon, g, l, t0, tf, theta0, thetaDot0) {
    ...
    while ( t[i] < tf ) {
        ...
        [theta1, thetaDoDeltat, theta2, thetaDot2] = approximatorRKF45(g, l, dt, t, theta, thetaDot, i);
    
        // The following are used to correct the step size
        [i, dt, t, theta, thetaDot] = stepSizeChecker(theta1, theta2, thetaDoDeltat, thetaDot2, epsilon, i, dt, t, theta, thetaDot);
    }
