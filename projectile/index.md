...
@def hassim=true
@def vars = ["x", "dx", "y", "dy"]
@def params = (g=(val=9.81, desc="Gravitational acceleration in metres per second squared."),b=(val=0.1, desc="Linear dissipation coefficient divided by projectile mass"), c=(val=0.02, desc="Quadratic dissipation coefficient divided by projectile mass"), tf=(val=16, desc="End time for the simulation in seconds."),x0=(val=0, desc="Initial horizontal position of projectile."),dx0=(val=100, desc="Initial horizontal velocity of projectile"), y0=(val=0, desc="Initial vertical position of projectile."),dy0=(val=100, desc="Initial vertical velocity of projectile."), epsilon=(val=1e-9,), t1=(val=14,))
