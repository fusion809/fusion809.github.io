 ...
 */
function approximatorRKF45(dt, sigma, rho, beta, t, x, y, z, i) {
    // Runge-Kutta-Fehlberg approximations of the change in x, y and z over the step
    // 1st approx
    var k1 = dt*f(sigma, rho, beta, t[i], x[i], y[i], z[i])[0];
    var l1 = dt*f(sigma, rho, beta, t[i], x[i], y[i], z[i])[1];
    var m1 = dt*f(sigma, rho, beta, t[i], x[i], y[i], z[i])[2];
    // 2nd approx
    var k2 = dt*f(sigma, rho, beta, t[i]+dt/4, x[i]+k1/4, y[i]+l1/4, z[i]+m1/4)[0];
    var l2 = dt*f(sigma, rho, beta, t[i]+dt/4, x[i]+k1/4, y[i]+l1/4, z[i]+m1/4)[1];
    var m2 = dt*f(sigma, rho, beta, t[i]+dt/4, x[i]+k1/4, y[i]+l1/4, z[i]+m1/4)[2];
    // 3rd approx
    var k3 = dt*f(sigma, rho, beta, t[i]+3*dt/8, x[i]+3*k1/32+9*k2/32, y[i]+3*l1/32+9*l2/32, z[i]+3*m1/32+9*m2/32)[0];
    var l3 = dt*f(sigma, rho, beta, t[i]+3*dt/8, x[i]+3*k1/32+9*k2/32, y[i]+3*l1/32+9*l2/32, z[i]+3*m1/32+9*m2/32)[1];
    var m3 = dt*f(sigma, rho, beta, t[i]+3*dt/8, x[i]+3*k1/32+9*k2/32, y[i]+3*l1/32+9*l2/32, z[i]+3*m1/32+9*m2/32)[2];
    // 4th approx
    var k4 = dt*f(sigma, rho, beta, t[i]+12*dt/13, x[i]+1932*k1/2197-7200*k2/2197+7296*k3/2197, y[i]+1932*l1/2197-7200*l2/2197+7296*l3/2197, z[i]+1932*m1/2197-7200*m2/2197+7296*m3/2197)[0];
    var l4 = dt*f(sigma, rho, beta, t[i]+12*dt/13, x[i]+1932*k1/2197-7200*k2/2197+7296*k3/2197, y[i]+1932*l1/2197-7200*l2/2197+7296*l3/2197, z[i]+1932*m1/2197-7200*m2/2197+7296*m3/2197)[1];
    var m4 = dt*f(sigma, rho, beta, t[i]+12*dt/13, x[i]+1932*k1/2197-7200*k2/2197+7296*k3/2197, y[i]+1932*l1/2197-7200*l2/2197+7296*l3/2197, z[i]+1932*m1/2197-7200*m2/2197+7296*m3/2197)[2];
    // 5th approx
    var k5 = dt*f(sigma, rho, beta, t[i]+dt, x[i]+439*k1/216-8*k2+3680*k3/513-845*k4/4104, y[i]+439*l1/216-8*l2+3680*l3/513-845*l4/4104, z[i]+439*m1/216-8*m2+3680*m3/513-845*m4/4104)[0];
    var l5 = dt*f(sigma, rho, beta, t[i]+dt, x[i]+439*k1/216-8*k2+3680*k3/513-845*k4/4104, y[i]+439*l1/216-8*l2+3680*l3/513-845*l4/4104, z[i]+439*m1/216-8*m2+3680*m3/513-845*m4/4104)[1];
    var m5 = dt*f(sigma, rho, beta, t[i]+dt, x[i]+439*k1/216-8*k2+3680*k3/513-845*k4/4104, y[i]+439*l1/216-8*l2+3680*l3/513-845*l4/4104, z[i]+439*m1/216-8*m2+3680*m3/513-845*m4/4104)[2];
    // 6th approx
    var k6 = dt*f(sigma, rho, beta, t[i]+dt/2, x[i]-8*k1/27+2*k2-3544*k3/2565+1859*k4/4104-11*k5/40, y[i]-8*l1/27+2*l2-3544*l3/2565+1859*l4/4104-11*l5/40, z[i]-8*m1/27+2*m2-3544*m3/2565+1859*m4/4104-11*m5/40)[0];
    var l6 = dt*f(sigma, rho, beta, t[i]+dt/2, x[i]-8*k1/27+2*k2-3544*k3/2565+1859*k4/4104-11*k5/40, y[i]-8*l1/27+2*l2-3544*l3/2565+1859*l4/4104-11*l5/40, z[i]-8*m1/27+2*m2-3544*m3/2565+1859*m4/4104-11*m5/40)[1];
    var m6 = dt*f(sigma, rho, beta, t[i]+dt/2, x[i]-8*k1/27+2*k2-3544*k3/2565+1859*k4/4104-11*k5/40, y[i]-8*l1/27+2*l2-3544*l3/2565+1859*l4/4104-11*l5/40, z[i]-8*m1/27+2*m2-3544*m3/2565+1859*m4/4104-11*m5/40)[2];
...
function solveProblem(objectOfInputs) {
    ...
    var {sigma, rho, beta, t0, tf, x0, y0, z0, epsilon, dtInitial} = objectOfInputs;
    ...
    while ( t[i] < tf ) {
        ...
        var [x1, y1, z1, x2, y2, z2] = approximatorRKF45(dt, sigma, rho, beta, t, x, y, z, i);
