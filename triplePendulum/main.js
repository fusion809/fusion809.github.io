function f(objectOfInputs, t, vars, dt) {
    ...
    // var v2r = Math.sqrt(l1**2*dtheta1**2/4 + l1*l2*dtheta1*dtheta2*Math.cos(Delta21)+l2**2*dtheta2**2/4);
    // var v3r = Math.sqrt(l1**2*dtheta1**2/4 + l2**2*dtheta2**2/4 + l3**2*dtheta3**2/4 + l1*l2*dtheta1*dtheta2*Math.cos(Delta21) + l1*l3*dtheta1*dtheta3*Math.cos(Delta31)+2*l2*l3*dtheta2*dtheta3*Math.cos(Delta32))
    var m123 = m1 + m2 + m3;
    var m23 = m2 + m3;
