 ...
 *
 * @param objectOfInputs An object containing the parameters on the form.
...
function solveProblem(objectOfInputs) {
    ...
    var {beta, gamma, delta, t0, tf, S0, I0, R0, dtInitial, epsilon} = objectOfInputs;
