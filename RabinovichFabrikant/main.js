...
function generateXYPhasePlot(solution) {
    ...
    // Generate phase plot
    gen2DPlot(x, y, "phasePlotXY", "Rabinovich&ndash;Fabrikant system: y against x phase plot.", "x", "y");
}
...
function generateXZPhasePlot(solution) {
    ...
    // Generate phase plot
    gen2DPlot(x, z, "phasePlotXZ", "Rabinovich&ndash;Fabrikant system: z against x phase plot.", "x", "z");
}
...
function generateYZPhasePlot(solution) {
    ...
    gen2DPlot(y, z, "phasePlotYZ", "Rabinovich&ndash;Fabrikant system: z against y phase plot.", "y", "z");
}
...
function generateTimePlot(solution) {
    // Generate time plot
    genMultPlot(solution, ["x", "y", "z"], "timePlot", "Rabinovich&ndash;Fabrikant system: plot of x, y and z against time.");
}
